...
// Embed the EOD Job Costing template so the Netlify function bundle always has it.
const eodTemplate = (await readFile('templates/Job_Costing_Worksheet_V2.xlsx')).toString('base64');
await writeFile('lib/eod-template.mjs', `// Generated by scripts/build.mjs from templates/Job_Costing_Worksheet_V2.xlsx.\n// Replace that file (same layout) and rebuild to change the EOD template.\nexport const JOB_COSTING_TEMPLATE_B64 = '${eodTemplate}';\n`);
